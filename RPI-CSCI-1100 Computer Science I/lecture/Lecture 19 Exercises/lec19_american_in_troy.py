...
if __name__ == "__main__":
    ...
    for r in restaurants:
        #print(r.name)
        #print(r.address.count("Troy"))
        #print(r.category.count("American"))
        #print(r.average_review())
        #print("")
        if r.address[1].count("Troy")==1 and r.category.count("American")==1 and r.average_review()>3:
            bum.append(r.name)
    bum.sort()
