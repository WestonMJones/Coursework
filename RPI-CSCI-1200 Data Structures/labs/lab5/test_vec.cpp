...
int main() {
  ...
  for (unsigned int x=0;x<20;x++) {
    if (x<5) {
      test_v1.push_back(73);
    } else {
      test_v1.push_back(73);
    }
  }
  test_v1.print();
  remove_matching_elements(test_v1,73);
  test_v1.print();


 /* Vec<std::string> test_v2;
  test_v2.push_back("Ugh");
  test_v2.push_back("Blah");
  test_v2.push_back("No");
  test_v2.push_back("Staph");

  cout << "\n\n\nCORNER CASES\n\n\n";
  test_v2.print();
  remove_matching_elements(test_v2,"Not here");
  remove_matching_elements(test_v2,"Ugh");
  remove_matching_elements(test_v2,"Staph");*/
